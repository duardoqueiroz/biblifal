...
--- users ---
INSERT INTO users (id, name, email, password, is_manager) VALUES (1, "Guilherme de Jesus", "gui@aluno.ifal.edu.br", "12345678", DEFAULT);

INSERT INTO users (id, name, email, password, is_manager) VALUES (2, "Eduardo Queiroz", "dudu@aluno.ifal.edu.br", "12345678", DEFAULT);

INSERT INTO users (id, name, email, password, is_manager) VALUES (3, "Jesse Diego", "jess@aluno.ifal.edu.br", "12345678", DEFAULT);
