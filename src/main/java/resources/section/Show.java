...
public class Show extends javax.swing.JFrame {
         ...
         */
        private SectionsController uc = new SectionsController();
        private User user;

        void updateList() {
                ArrayList<Section> sections = uc.findAll();

                String[] sectionsVector = new String[sections.size()];

                for (int i = 0; i < sectionsVector.length; i++) {
                        String section = "Nome : " + sections.get(i).getName();

                        int totalShelfs = 0;
                        ArrayList<Shelf> shelfs = uc.findShelfs(sections.get(i).getId());
                        for (Shelf shelf : shelfs) {
                                totalShelfs = totalShelfs + 1;
                        }
                        jLabel2.setText("Quantidade de estantes: " + totalShelfs);
                        String quantity = "Quantidade de estantes : " + shelfs.size();
                        String id = String.valueOf(sections.get(i).getId());
                        sectionsVector[i] = id + " - " + section + " | " + quantity;

                }
                jList1.setListData(sectionsVector);
        }
        ...
        private void initComponents() {
                ...
                jLabel2.setText("Aqui você pode ver as seções cadastradas");
        ...
        private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
                if (jList1.getSelectedValue() != null) {
                        ...
                        if (element != -1) {
                                ShowShelfs sb = new ShowShelfs(uc.find(element), this.user);
                                this.dispose();
                                sb.setVisible(true);
                        }
                }
